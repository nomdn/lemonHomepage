---
title: 域名变动须知
publishDate: 2026-3-8 08:00:00
description: '一些域名变动的通知'
tags:
  - Notice
language: '中文'
---
## 2026-3-8  
大部分服务的主域名都从**wsmdn.top**转到了**wsmdn.dpdns.org**  
受影响的项目：
| 项目      | 原域名 |   现域名     |
| ------- | ----------- |  --------- |
| DressAPI V2     | api.wsmdn.top       |   api.wsmdn.dpdns.org        |
| DressAPI V1   | dress.wsmdn.top        |    dress.wsmdn.dpdns.org    |
| 柠檬论坛  |   forum.wsmdn.top       |   forum.wsmdn.dpdns.org       |
| 柠檬博客   |  blog.wsmdn.top         |    blog.wsmdn.dpdns.org       |                         
| 柠檬监控（uptimeflare）| status.wsmdn.top| status.wsmdn.dpdns.org|
